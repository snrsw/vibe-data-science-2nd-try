    ...
    with mlflow_run(
        ...
        if config.model.model_type == "lightgbm":
            mlflow.lightgbm.log_model(
                ...
                "lightgbm_model",
                signature=signature,
                registered_model_name="penguin-classifier" if config.mlflow.register_model else None,
            )
...
def run_prediction(
    ...
    # Make predictions
    predictions = model.predict(df.select(PenguinDataSchema.feature_columns + PenguinDataSchema.categorical_columns))
